-- yourcaryourway.agencies definition
...
-- yourcaryourway.message definition
...
CREATE TABLE `message` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_message_conv_created` (`conversation_key`,`created_at`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;


-- yourcaryourway.users definition
...
-- yourcaryourway.support_tickets definition
...
-- yourcaryourway.vehicles definition
...
-- yourcaryourway.reservations definition
...
-- yourcaryourway.payments definition
